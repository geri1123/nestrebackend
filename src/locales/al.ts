...
reviewCreatedSuccessfully: "Vlerësimi u krijua me sukses.",
  ...
  agencyNameAlreadyExists: "Emri i agjencisë tashmë ekziston.",
...
advertisementTypeNotActive:"Ky lloj reklame aktualisht nuk është aktiv.",
    usernameChangedSuccessfully: "Emri i përdoruesit u ndryshua me sukses.",
     ...
     cannotUpdateOwnAgent: "Nuk mund të përditësoni profilin tuaj të agjentit.",
         passwordNotSetForUser:"Ky llogari përdor hyrjen me Google. Duhet të vendosni një fjalëkalim përpara se ta ndryshoni.",
  googleUsersCannotChangePassword: "Ky llogari përdor hyrjen me Google. Nuk mund të ndryshohet fjalëkalimi.",
  passwordCreatedSuccessfully: "Fjalëkalimi u vendos me sukses",
descriptionTooManyWords: "Përshkrimi nuk mund të ketë më shumë se 100 fjalë.",
descriptionMustBeString: "Përshkrimi duhet të jetë një varg i vlefshëm.",
agencyUpdatedSuccess: "Agjencia u përditësua me sukses",
     ...
     usernameRequired: "Emri i përdoruesit është i detyrueshëm.",
      ...
      amountMustBePositive: "Shuma duhet të jetë pozitive",
       ...
       cannotUpdateHigherOrEqualRole: "Nuk mund të përditësoni një agjent me rol të barabartë ose më të lartë se juaji",
cannotAssignHigherOrEqualRole: "Nuk mund të caktoni një rol të barabartë ose më të lartë se roli juaj",
productNotActive:"Ky produkt nuk është aktiv.",
cannotUpdateTerminatedAgent: "Nuk mund të përditësoni një agjent të përfunduar",
...
walletAlreadyExists:"Portofoli ekziston tashmë.",
