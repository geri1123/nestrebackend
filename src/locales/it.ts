export const it = {
  ...
  cannotReviewOwnAgency: "Non puoi recensire un'agenzia di cui fai parte.",
...
notReviewAuthor: "Solo l'autore della recensione può modificarla.",
reviewCreatedSuccessfully: "Recensione creata con successo.",
...
agencyNameAlreadyExists: "Il nome dell'agenzia esiste già.",
...
userUpdatedSuccess:"Utente aggiornato con successo .",
         passwordNotSetForUser:"Questo account utilizza l'accesso con Google. Devi impostare una password prima di cambiarla.",
  googleUsersCannotChangePassword: "Questo account utilizza l'accesso con Google. Impossibile modificare la password.",
  passwordCreatedSuccessfully: "Password impostata con successo",
descriptionTooManyWords: "La descrizione non può superare le 100 parole.",
descriptionMustBeString: "La descrizione deve essere una stringa valida.",
agencyUpdatedSuccess: "Agenzia aggiornata con successo",
cannotSaveOwnProduct:"Non puoi salvare il tuo prodotto",
    ...
    cannotUpdateHigherOrEqualRole: "Non puoi aggiornare un agente con un ruolo uguale o superiore al tuo",
cannotAssignHigherOrEqualRole: "Non puoi assegnare un ruolo uguale o superiore al tuo",
cannotUpdateTerminatedAgent: "Impossibile aggiornare un agente terminato",
...
sameUsername: "Il nuovo nome utente non può essere uguale al nome utente attuale.",
 ...
 successfullyAdvertised: "Prodotto pubblicizzato con successo",
   ...
   cannotUpdateOwnAgent: "Non puoi aggiornare il tuo profilo agente.",
  websiteInvalid: "L'URL del sito web non è valido",
   ...
   agencyInactive: "L'agenzia non è attiva",
    ...
    amountAddedSuccessfully:"Importo aggiunto con successo", 
        invalidTransactionType: "Tipo di transazione non valido",
