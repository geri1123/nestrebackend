...
cannotAssignHigherOrEqualRole: "You cannot assign a role equal to or higher than your own",
cannotUpdateTerminatedAgent: "Cannot update a terminated agent",
notificationMarkedAsRead: 'Notification marked as read',
cannotUpdateOwnAgent: "You cannot update your own agent profile.",
...
sameUsername: "The new username cannot be the same as the current username.",
    ...
    noPermissionToAdvertise:"You do not have permission to advertise this product.",
     emailNotVerified: "User must verify their email before approval.",
