...
import { agencyagent_role_in_agency, agencyagent_status, LanguageCode } from "@prisma/client";
...
import { hasAgentChanges } from "./helpers/agent-change-translator";
...
async updateAgencyAgents(
  ...
  const hasChanges = hasAgentChanges(dto, {
    ...existingAgent,
